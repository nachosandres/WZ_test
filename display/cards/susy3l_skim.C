
{
    ...
    string fileName="template3L_skimmed";
    string fileList="template3L_skimmed"; 
    string hName="";
    ...
    md.anConf.addSample( "T5ttttDeg_mGo1000_mStop300_mCh285_mChi280"    ,  "T5t410" , kBlue+1  );
    md.anConf.addSample( "T5qqqqWZDeg_mGo1000_mCh315_mChi300_dilep"    ,  "T5q4WZ315" , kGreen+1  );
    md.anConf.addSample( "T5qqqqWZDeg_mGo1000_mCh325_mChi300_dilep"    ,  "T5q4WZ325" , kGreen+2  );
    md.anConf.addSample( "T5qqqqWZ_mGo1200_mCh1000_mChi800_dilep"    ,  "T5q4WZ12" , kGreen+3  );
    md.anConf.addSample( "T5qqqqWZ_mGo1500_mCh800_mChi100_dilep"    ,  "T5q4WZ15" , kGreen+4  );
    md.anConf.addSample( "T5qqqqZZDeg_mGo1000_mCh315_mChi300_dilep"    ,  "T5q4ZZ315" , kCyan+1  );
    md.anConf.addSample( "T5qqqqZZDeg_mGo1000_mCh325_mChi300_dilep"    ,  "T5q4ZZ325" , kCyan+2  );
    md.anConf.addSample( "T5qqqqZZ_mGo1200_mCh1000_mChi800_dilep"    ,  "T5q4ZZ12" , kCyan+3  );
    md.anConf.addSample( "T5qqqqZZ_mGo1500_mCh800_mChi100_dilep"    ,  "T5q4ZZ15" , kCyan+4  );
