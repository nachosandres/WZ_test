{
  ...
  string fileName="phys14exerc_new"; // not needed for statistics
  string fileList="phys14exerc_new"; // put command line that gives all files as in a "ls" command
  ...
  //observables **********************
  //string obs[6]={"","","","","",""};
    md.dp.setObservables("SRHTBin_HT");
  ...
  LumisXS[ "SMS-T1tttt_2J_mGl-1200_mLSP-800_Tune4C_13TeV-madgraph-tauola_skim"] = 100322 / (0.0856418 * 20.);
  //LumisXS[ "SMS-T1tttt_2J_mGl-1500_mLSP-100_Tune4C_13TeV-madgraph-tauola_skim"] = 105679 / (0.0141903 * 20.);
  ...
  md.anConf.addSample( "SMS-T1tttt_2J_mGl-1200_mLSP-800_Tune4C_13TeV-madgraph-tauola_skim", "T1tttt (1.2/0.8) sig * 20", kViolet-3);
  //md.anConf.addSample( "SMS-T1tttt_2J_mGl-1500_mLSP-100_Tune4C_13TeV-madgraph-tauola_skim", "T1tttt (1.5/0.1) sig * 20", kViolet-3);
  ...
  md.anConf.addSample( "T5qqqqWW_mGo1200_mCh1000_mChi800_skim"                            , "T5qqqqWW (1.2/0.8) sig * 20", kOrange+6); 
