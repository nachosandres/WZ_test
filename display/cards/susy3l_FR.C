{
    ...
    string dir="SUSY3L_FR";
    string fileName="template3L_FR"; //was treeName in LUNE susy_cut_lowpt
    string fileList="template3L_FR"; //CH: since AnaConfig needs a fileName to open, we need to put the data files into a different variable
    string hName="";
   ...
   // md.dp.setObservables("BR_NJets");
    ...
    md.dp.setObservables("BR_FRel");
    md.dp.setObservables("BR_FRmu");
