{
  ...
  string dir="SUSY3L";
  string fileName="susy3l_yields"; //was treeName in LUNE susy_cut_lowpt
  string fileList="susy3l_yields"; //CH: since AnaConfig needs a fileName to open, we need to put the data files into a different variable
  string hName="";
