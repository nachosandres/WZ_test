...
class SUSY3L_FR: public MPAF {

public:
    // Member Functions
    SUSY3L_FR(std::string);
    virtual ~SUSY3L_FR();
...
private:
    ...
    float _valCutVLepMultiplicityBR;
    ...
    std::string _cTypeVLepMultiplicityBR;
    ...
    float _upValCutVLepMultiplicityBR;
